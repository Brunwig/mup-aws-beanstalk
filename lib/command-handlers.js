...
async function awsLogin(api) {
    ...
    const profile = (_a = config.app.auth) === null || _a === void 0 ? void 0 : _a.profile;
    if (!profile) {
    ...
    (0, utils_1.logStep)(`=> Logging in to AWS SSO with profile: ${profile}`);
    console.log('');
