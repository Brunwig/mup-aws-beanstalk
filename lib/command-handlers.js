...
async function deploy(api) {
    ...
    if (finalEnvironments.every(environment => environment.VersionLabel === nextVersion.toString() &&
        environment.Health !== client_elastic_beanstalk_1.EnvironmentHealth.Red)) {
